...
This code calculates CIT and HCI from weather station data from ARSO and plots it.
...
A function to plot aggregated effective temperature data for one station:
